...
Load callNest project context for a fresh session.
...
1. Read CLAUDE.md (the project root one):
   ...
   ```bash
   cat "/home/primathon/Documents/p_projet/a_APP/4. callNest/CLAUDE.md"
   ```

2. Read the docs index:

   ```bash
   ls "/home/primathon/Documents/p_projet/a_APP/4. callNest/.claude/docs/"
   cat "/home/primathon/Documents/p_projet/a_APP/4. callNest/.claude/docs/README.md"
   ```

3. Read the latest CHANGELOG entry (last v):

   ```bash
   awk '/^## /{i++} i==1' "/home/primathon/Documents/p_projet/a_APP/4. callNest/CHANGELOG.md"
   ```
...
5. Show last-modified files (clue to where work stopped):
   ...
   ```bash
   find "/home/primathon/Documents/p_projet/a_APP/4. callNest/app/src/main" -name "*.kt" -newer "/home/primathon/Documents/p_projet/a_APP/4. callNest/CHANGELOG.md" 2>/dev/null | head -10
   ```
