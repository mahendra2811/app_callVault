...
Run JVM unit tests for callNest.
...
4. If failed, parse the failures and route to the `callNest-build-fixer` or `callNest-test-writer` agent depending on whether the failure is compile-time or assertion.
