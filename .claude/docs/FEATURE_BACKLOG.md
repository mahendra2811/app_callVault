...
- [ ] **Sign-up + password recovery wired through**  ICE 10·10·10 = **1000**  · **Effort: S**
  Replace the two empty lambdas in `CallVaultNavHost.kt:155–156` with a wired `authGraph()` sub-graph. Lands AUDIT CRIT-1.
  Layer: `ui/navigation/CallVaultNavHost.kt`, `ui/screen/auth/AuthNavGraph.kt`.
