...
When a call ends, CallVault can pop up a quick action sheet so you can capture the moment without opening the app.
...
## Permissions
Same overlay permission as the floating bubble. CallVault asks once and reuses it for both.
