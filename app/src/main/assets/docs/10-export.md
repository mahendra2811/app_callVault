...
callNest can export any slice of your call history to CSV or JSON — useful for spreadsheets, CRM imports, or one-off audits.
...
Exports are saved to `Documents/callNest/exports/` by default. Tap **Open** or **Share** from the success card to use the file straight away.
