...
import com.callvault.app.data.system.CallLogReader
import com.callvault.app.data.system.ContactsReader
import com.callvault.app.data.system.PhoneNumberNormalizer
import com.callvault.app.data.system.RawCallRow
import com.callvault.app.data.system.SimSlotResolver
...
class SyncCallLogUseCase @Inject constructor(
    ...
    suspend operator fun invoke(): SyncResult {
        ...
        val newCalls = ArrayList<com.callvault.app.domain.model.Call>()
        var maxId = lastId
        ...
        for (raw in raws) {
            try {
                ...
                if (raw.type == com.callvault.app.domain.model.CallType.OUTGOING.raw &&
    ...
    private data class EnrichedRow(
        ...
        fun toCall(): com.callvault.app.domain.model.Call =
            com.callvault.app.domain.model.Call(
                ...
                type = com.callvault.app.domain.model.CallType.fromRaw(raw.type),
