...
private val Context.dataStore by preferencesDataStore(name = "callvault_settings")
...
class SettingsDataStore @Inject constructor(
    ...
    val autoSavePrefix: Flow<String> = ds.data.read(K_AUTO_SAVE_PREFIX, "callVault")
    ...
    val autoSaveContactGroupName: Flow<String> =
        ds.data.read(K_AUTO_SAVE_GROUP_NAME, "CallVault Inquiries")
    ...
    // ---------- Sprint 4 ----------
    /** True after [com.callvault.app.data.local.seed.DefaultTagsSeeder] has populated the system tags. */
    val tagsSeeded: Flow<Boolean> = ds.data.read(K_TAGS_SEEDED, false)
    suspend fun setTagsSeeded(v: Boolean) = write(K_TAGS_SEEDED, v)

    /** Banner flag flipped on by [com.callvault.app.data.service.alarm.ExactAlarmScheduler]
