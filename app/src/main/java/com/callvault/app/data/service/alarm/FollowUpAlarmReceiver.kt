...
class FollowUpAlarmReceiver : BroadcastReceiver() {
    ...
    private fun postNotification(context: Context, intent: Intent) {
        ...
        val notification: Notification = NotificationCompat.Builder(
            context,
            CallVaultApp.CHANNEL_FOLLOW_UPS
        )
    ...
    companion object {
        const val ACTION_SNOOZE_1H = "com.callvault.app.action.FOLLOW_UP_SNOOZE_1H"
        const val ACTION_SNOOZE_1D = "com.callvault.app.action.FOLLOW_UP_SNOOZE_1D"
        const val ACTION_MARK_DONE = "com.callvault.app.action.FOLLOW_UP_MARK_DONE"
