package com.callvault.app.data.service
...
import com.callvault.app.data.service.overlay.OverlayManager
import com.callvault.app.data.service.overlay.PostCallPayload
import com.callvault.app.data.system.CallContextResolver
import com.callvault.app.data.system.PhoneStateMonitor
 ...
 *
 * Started/stopped by [com.callvault.app.util.RealTimeServiceController]
...
class CallEnrichmentService : LifecycleService() {
    ...
    private fun startInForegroundCompat() {
        ...
        val notification: Notification = NotificationCompat.Builder(this, CallVaultApp.CHANNEL_REALTIME_CALL)
    ...
    companion object {
        ...
        const val ACTION_STOP = "com.callvault.app.action.STOP_REALTIME"
