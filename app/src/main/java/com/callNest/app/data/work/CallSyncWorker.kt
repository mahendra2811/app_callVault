...
class CallSyncWorker @AssistedInject constructor(
    ...
    companion object {
        const val UNIQUE_PERIODIC_NAME = "callNest.sync.periodic"
        const val UNIQUE_ONESHOT_NAME = "callNest.sync.oneshot"
        const val UNIQUE_DAILY_NAME = "callNest.sync.daily2am"
        private const val WAKE_TAG = "callNest:CallSyncWorker"
