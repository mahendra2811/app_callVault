...
class DriveBackupClient @Inject constructor(
    ...
    /** Resolve (or create) the "callNest Backups" folder; returns its file id. */
    ...
    /** Multipart-upload [file] into the "callNest Backups" folder. Returns the new file id. */
    ...
    /** List `.cvb` backups inside the callNest Backups folder. */
    ...
    private companion object {
        const val FOLDER_NAME = "callNest Backups"
