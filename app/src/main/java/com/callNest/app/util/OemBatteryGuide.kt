...
object OemBatteryGuide {
    ...
    fun stepsFor(vendor: OemVendor): List<String> = when (vendor) {
        OemVendor.Xiaomi -> listOf(
            ...
            "Find callNest and turn the Autostart switch on.",
            "Go back, then open Battery saver and set callNest to No restrictions.",
            "Optional: lock callNest in Recents so MIUI never wipes it from memory."
        )
        OemVendor.Oppo -> listOf(
            "Tap Open settings to land on ColorOS' App startup manager.",
            "Find callNest and enable Allow auto-launch and Allow background activity.",
            "Open Battery > High background power consumption and add callNest.",
            "Lock callNest in Recents to keep ColorOS from killing it."
        )
        OemVendor.Vivo -> listOf(
            "Tap Open settings to open vivo's High background power consumption list.",
            "Find callNest and enable Allow background activity.",
            "Go back to Battery > Background power consumption management and allow callNest.",
            "Open i Manager > Autostart and turn callNest on."
        )
        OemVendor.Realme -> listOf(
            "Tap Open settings to open realme's App startup manager.",
            "Switch on Auto-launch and Allow background activity for callNest.",
            "Open Battery > Power saving and set callNest to Allow background running.",
            "Lock callNest in Recents so realme's task killer leaves it alone."
        )
        OemVendor.Samsung -> listOf(
            "Tap Open settings to land on Samsung's Battery > Background usage limits.",
            "Make sure callNest is NOT in Sleeping apps or Deep sleeping apps.",
            "Open Apps > callNest > Battery and pick Unrestricted.",
        ...
        OemVendor.OnePlus -> listOf(
            ...
            "Pick callNest, then choose Don't optimise.",
            "Open Battery > More battery settings and turn off Sleep standby optimisation.",
            "Lock callNest in Recents so OxygenOS keeps it warm."
        )
        OemVendor.Honor -> listOf(
            "Tap Open settings to open Honor's Startup manager.",
            "Switch callNest to Manage manually and enable all three toggles.",
            "Go back to Battery > More battery settings and turn off Power-intensive prompt.",
            "Lock callNest in Recents to survive Magic OS task cleanup."
        )
        OemVendor.Huawei -> listOf(
            "Tap Open settings to open Huawei's App launch screen.",
            "Switch callNest to Manage manually, then enable Auto-launch, Secondary launch, and Run in background.",
            "Open Battery > App launch settings and confirm callNest is allowed.",
            "Lock callNest in Recents so EMUI does not freeze it."
        )
        OemVendor.Other -> listOf(
            "Tap Open settings to open the system battery optimization screen.",
            "Pick callNest and choose Don't optimise so background sync keeps running.",
            "If your device has an Autostart or App launch screen, allow callNest there too.",
            "Lock callNest in Recents to keep it out of the system's task killer."
        )
    }
