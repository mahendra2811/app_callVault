...
import com.callNest.app.domain.model.WeeklyDigest
...
class ComputeWeeklyDigestUseCase @Inject constructor(
    ...
    suspend operator fun invoke(nowMs: Long = System.currentTimeMillis()): WeeklyDigest {
        ...
        calls.forEach { c ->
            when (com.callNest.app.domain.model.CallType.fromRaw(c.type)) {
                com.callNest.app.domain.model.CallType.INCOMING -> incoming++
                com.callNest.app.domain.model.CallType.OUTGOING -> outgoing++
                com.callNest.app.domain.model.CallType.MISSED,
                com.callNest.app.domain.model.CallType.REJECTED,
                com.callNest.app.domain.model.CallType.BLOCKED -> missed++
                else -> Unit
            }
        }
