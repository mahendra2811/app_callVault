 ...
 *
 * @param progress current count of imported rows (mirrors [com.callNest.app.domain.usecase.SyncProgress.Progress.current]).
 * @param total declared total rows; `0` means indeterminate.
 * @param done set true after [com.callNest.app.domain.usecase.SyncProgress.Done] arrives.
        ...
        when {
            error != null -> {
                ...
                com.callNest.app.ui.components.neo.NeoSurface(
                    ...
                    elevation = com.callNest.app.ui.theme.NeoElevation.ConcaveSmall,
