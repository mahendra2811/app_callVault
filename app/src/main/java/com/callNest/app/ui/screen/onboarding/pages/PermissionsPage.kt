...
/**
 * Onboarding page 3 — explains every runtime permission callNest asks for.
 *
 ...
 * @param launcher pre-built launcher (typically from [com.callNest.app.util.rememberPermissionLauncher]).
 */
@Composable
fun PermissionsPage(
    onContinue: () -> Unit,
...
private fun PermissionsPagePreview() {
    CallNestTheme { PermissionsPage(onContinue = {}, launcher = null) }
}
