...
class PipelineViewModel @Inject constructor(
    ...
    private val callDao: com.callNest.app.data.local.dao.CallDao,
    private val pipeline: PipelineRepository,
    private val settings: com.callNest.app.data.prefs.SettingsDataStore,
    private val demoSeeder: com.callNest.app.data.demo.DemoSeeder,
) : ViewModel() {
