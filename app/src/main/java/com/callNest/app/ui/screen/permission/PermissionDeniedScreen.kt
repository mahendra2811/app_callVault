package com.callNest.app.ui.screen.permission
 ...
 *
 * The only path forward is opening the app's system Settings page; callNest
...
private fun PermissionDeniedScreenPreview() {
    CallNestTheme { PermissionDeniedScreen(onOpenSettings = {}) }
}
