 ...
 * [com.callNest.app.data.prefs.SettingsDataStore] via the view-model.
 *
        ...
        LazyColumn(
            ...
            item("about") {
                SectionCard(stringResource(R.string.settings_section_about)) {
                    val pkg = com.callNest.app.BuildConfig.VERSION_NAME
                    val build = com.callNest.app.BuildConfig.VERSION_CODE
                    Text(
